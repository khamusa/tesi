...
eccezioni riuscivamo a trovare per le regole che avevamo 
...
pretesa di avere valore scientifico. Il mio obbiettivo nel
...
abbiamo percepito che, ad ogni iterazione, avremo dovuto
...
\begin{itemize}
  ...
  \item Basandoci su una quantità significativa di oggetti \textit{mock} 
  per poter stimolare una quantità significativa di casi, 
  senza dover pagare gli eccessivi tempi di I/O dei file veri. 
  La difficoltà stava nell'elaborazione dei casi specifici di test: o 
...
In entrambi i casi i vantaggi del TDD calavano al passo che il costo 
aumentava: per poter scrivere un caso di test per testare la prima estrazione
ci verrebbe richiesto uno sforzo molto alto. La stesura di un singolo 
caso di test consisteva già un costo alto da pagare in questo momento,
perché era circondata da incertezze.

Analizzando le opzioni, ci rimaneva soltanto una possibilità: cercare di
ridurre l'incertezza. Avevamo bisogno di fare qualche assunzione, ma
non riuscivamo a trovare proprietà che venissero rispettate nel 100\%
dei casi. L'unica via di uscita sarebbe dimenticarci dell'ideale 100\%.

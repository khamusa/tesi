...
%% SAM: avevo la speranza che fosse stato un errore di battitura solo qua. Invece
%% ho appena verificato il documento di cambio titolo presentato e si, ho sbagliato anche li. Ho
%% commesso l'errore di battitura a monte, e quello si è propagato fin qua.
%% Cosa conviene fare?
...
%% SAM: ok,  la sistemo con calma al fine settimana.
%
%			BIBLIOGRAFIA
%

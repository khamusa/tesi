...
\begin{itemize}
  ...
  \item Introspezione sui metodi e funzioni utilizzate, esibendo direttamente sulla REPL dettagli sulla loro segnatura e anche documentazione (\textit{docstring}).
  \item Possibilità di salvare il codice utilizzato direttamente sul \textit{filesystem}
...
\newpage\newgeometry{left=3cm, right=2.5cm}\pythonexternal[caption=Versione iniziale del metodo update\_buildings,frame=tlrb,numbers=left]{code_samples/building_data_updater_before.py}
...
\newpage\pythonexternal[caption=Versione finale del metodo update\_buildings,frame=tlrb]{code_samples/building_data_updater_after.py}

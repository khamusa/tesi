...
\textit{
(Nota dell'autore: qualsiasi allusione a Pirandello in questo
sottotitolo non è frutto di coincidenza)
}
...
orientata ad oggetti proposti da Robert C. Martin. I principi sono Single
...
lo volevo toglierlo (mi stava bene :D). Ho incominciato con RoomDataUpdater,
...
termini: ``A class should have only one reason to change''\cite{bobmartin2003}.
...
codice sopra, e per questo motivo evito di comentarlo e passo 
...
in cui il primo va fatto all'interno del ciclo for di aggiornamento, e il 

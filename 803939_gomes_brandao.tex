...
casi sopra elencati, e \textbf{se ne accorge} quando non riesce a 
trovare un'associazione soddisfacente fra i piani. 
...
che gli altri lemmi del TDD, in speciale quello del refactoring 
